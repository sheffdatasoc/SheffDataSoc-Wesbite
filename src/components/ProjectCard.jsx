/* ========================================
   ProjectCard.jsx - UPDATED VERSION
   ======================================== */
...
function ProjectCard({ project, featured, isSandbox }) {
  ...
  const singleButton = (finalGithubUrl && !finalDemoUrl) || (!finalGithubUrl && finalDemoUrl);
      ...
      <footer className="project-footer">
        <div className="project-buttons">
          {finalGithubUrl && (
            <a
              href={finalGithubUrl}
              className={`btn-github ${singleButton ? 'full-width' : ''}`}
              target="_blank"
          ...
          {finalDemoUrl && (
            <a
              href={finalDemoUrl}
              className={`btn-demo ${singleButton ? 'full-width' : ''}`}
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
